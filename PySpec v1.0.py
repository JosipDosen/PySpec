...
print (""" 
 ...
 / /                                                                    \\
  ...
  | 	| C:\> Welcome, User to PySpec 			           |     | 
  | 	| C:\> Analyzing your PC's Hardware Specifications 	   |	 |
  |     |                      					   |	 |
  |	|							   |	 |
  |	|							   |	 |
  |	| 							   |	 |
  ...
  |	|							   |	 |
  |	|							   |	 |
  |	|C:\> Program written and made by Mr. Slavic	           |	 |
  | 	|C:\> https://github.com/JosipDosen                        | 	 |
  |     |C:\> https://steamcommunity.com/id/Mr_Slavic/             |     |
  |     |                                                          |     |
...
# Grab the info of the installed Graphics Cards in this PC
